...
vtk = VtkHandler(joinpath(out_dir, "linear_transport_$rank.pvd"), parent(mesh))
...
for i in 1:nite
    ...
    ## Update solution
    set_dof_values!(u, u.dofValues .+ rhs)
...
@one_at_a_time println("end of script")
